defmodule ElixirGraphQLWeb.ConnCase do
  ...
  using do
    quote do
      ...
      use ElixirGraphQLWeb, :verified_routes
  ...
  setup tags do
    ElixirGraphQL.RepoCase.setup_sandbox(tags)
  ...
  def authenticated(conn, user) do
    Plug.Conn.put_req_header(conn, "authorization", "Bearer #{ElixirGraphQLWeb.AuthToken.create(user)}")
  end
end
